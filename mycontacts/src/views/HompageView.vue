<template>
  <NavBar />
  <div class="text-center mt-40 text-bold">
    <h1>
      Bienvenue sur My Contact <br />
      Un site facilitant l'enregistrement de contact
    </h1>
  </div>
...
<script>
import FooTer from "@/components/DetailsPage/FooTer.vue";
import NavBar from "@/components/DetailsPage/NavBar.vue";
import ConTacts from "@/components/DetailsPage/ConTacts.vue";
export default {
  name: "HomeView",
  components: {
    FooTer,
